...
const RentablePets = artifacts.require("RentableMonkey");
...
contract("RentablePets", function (accounts) {
  it("should support the ERC721 and ERC4907 standards", async () => {
    ...
    assert.equal(isERC721, true, "RentableMonkey is not an ERC721");
    assert.equal(isER4907, true, "RentableMonkey is not an ERC4907");
  });
